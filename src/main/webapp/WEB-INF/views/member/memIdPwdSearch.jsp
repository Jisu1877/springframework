...
<form>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link btn-outline-secondary" href="memLogin">돌아가기</a>
    </li>
  </ul>
  ...
  <div class="container"><input type="button" value="로그인창으로 이동" onclick="location.href='memLogin';" class="btn btn-info form-control"/></div>
</form>
</div>
<p><br/></p>
