...
<div class="container">
    ...
    <form name="myForm" method="post">
    	...
    	<table class="table table-bordered">
    		...
    		<tr>
    			<th>나이</th>
    			<td><input type="number" name="age" class="form-control" value="20"></td>
    		</tr>
    		<tr>
    			<th>주소</th>
    		...
    		<tr>
    			<td colspan="2" style="text-align: center">
    				...
    				<a href="personList" class="btn btn-info">리스트로가기</a>
    			</td>
    		</tr>
    	</table>
    </form>
